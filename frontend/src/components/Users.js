            ...
            <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                ...
                <div className="flex justify-center items-center h-full">
                    <div className="text-white text-center px-14 px-md-0">
                        <h2 className="text-3xl font-semibold mb-4">Welcom!
                         {/* {{ #if mesg }} */}
                            {/* <h3 className="title-font font-medium text-3xl text-green-600 ">  */}
                            {/* {{ userEmail }} */} User
                            {/* </h3> */}
                            {/* {{/if}} */}
                        </h2>
                        <h5 className="text-lg font-semibold mb-6">to User page</h5>
